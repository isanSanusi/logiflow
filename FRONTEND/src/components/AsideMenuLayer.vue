...
// ambil state reaktif dari kedua store
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div class="text-center p-6 flex-1 lg:text-left lg:pl-6 xl:text-center xl:pl-0">
          <p
            v-for="me in authStore.me"
            :key="me.id"
            class="font-semibold text-lg text-blue-400"
          >
            {{ !me.company ? "DEVELOPER" : me.company.name }}
          </p>
        </div>
        <button
